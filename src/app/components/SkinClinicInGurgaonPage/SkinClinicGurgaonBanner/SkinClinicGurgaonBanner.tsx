...
import styles from './SkinClinicGurgaonBanner.module.css';

interface Props {
	section: { image: string; mobileImage?: string; imagemobile?: string; altTag?: string; heading: string } | null;
}

export default function SkinClinicGurgaonBanner({ section }: Props) {
	...
	return (
		<section className={styles.SkinClinicGurgaonBanner}>
