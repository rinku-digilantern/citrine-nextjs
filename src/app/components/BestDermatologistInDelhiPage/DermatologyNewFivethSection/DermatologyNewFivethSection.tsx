...
import styles from "./DermatologyNewFivethSection.module.css";
...
const DermatologyNewFivethSection: React.FC<Props> = ({ section }) => {
  if (!section) return null;
  return (
    <section className={styles.DermatologyNewFivethSection}>
...
export default DermatologyNewFivethSection;
