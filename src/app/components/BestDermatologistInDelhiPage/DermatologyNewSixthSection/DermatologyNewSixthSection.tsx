...
import styles from "./DermatologyNewSixthSection.module.css";
...
const DermatologyNewSixthSection: React.FC<Props> = ({ section }) => {
  if (!section) return null;
  return (
    <section className={styles.DermatologyNewSixthSection}>
...
export default DermatologyNewSixthSection;
