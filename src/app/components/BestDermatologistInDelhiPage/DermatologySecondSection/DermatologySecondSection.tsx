...
import styles from "./DermatologySecondSection.module.css";
...
const DermatologySecondSection: React.FC<Props> = ({ section }) => {
  if (!section) return null;
  return (
    <section className={styles.DermatologySecondSection}>
...
export default DermatologySecondSection;
