...
import styles from "./DermatologyNewEightthSection.module.css";
...
const DermatologyNewEightthSection: React.FC<Props> = ({ section }) => {
  if (!section) return null;
  return (
    <section className={styles.DermatologyNewEightthSection}>
...
export default DermatologyNewEightthSection;
