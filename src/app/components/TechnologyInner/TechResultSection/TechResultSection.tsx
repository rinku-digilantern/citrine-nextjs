...
import styles from './TechResultSection.module.css';
...
const TechResultSection: React.FC<ResultSectionProps> = ({ 
  title, 
  results,
  showViewMore = true 
}) => {
  ...
  const sectionTitle = title || 'Before & After Ultherapy Treatment';

  return (
    <section id="result" className={styles.TechResultSection}>
...
export default TechResultSection;
