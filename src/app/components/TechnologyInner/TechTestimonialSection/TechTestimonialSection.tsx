...
import styles from './TechTestimonialSection.module.css';
...
interface TechTestimonialSectionProps {
  title?: string;
  testimonials?: Testimonial[];
}

const TechTestimonialSection: React.FC<TechTestimonialSectionProps> = ({ 
  title, 
  testimonials 
}) => {
  ...
  return (
    <section id="testimonial" className={styles.TechTestimonialSection}>
      <Image 
...
export default TechTestimonialSection;